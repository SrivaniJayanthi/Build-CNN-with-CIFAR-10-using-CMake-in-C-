...
void compareFile_batch1() {
    std::string file1 = "C:/Users/7501/Downloads/projects/Projects_MCW/data/output/batch1_output_1d.txt";
    std::string file2 = "C:/Users/7501/Downloads/projects/Projects_MCW/data/references/layer_bn1.txt";
    std::string output = "C:/Users/7501/Downloads/projects/Projects_MCW/report/Batch1_inference.txt";
