...
void compareFile_conv1() {
    std::string file1 = "C:/Users/7501/Downloads/projects/Projects_MCW/data/output/conv1_output_1d.txt";
    std::string file2 = "C:/Users/7501/Downloads/projects/Projects_MCW/data/references/layer_conv1.txt";
    std::string output = "C:/Users/7501/Downloads/projects/Projects_MCW/report/Conv1_inference.txt";
