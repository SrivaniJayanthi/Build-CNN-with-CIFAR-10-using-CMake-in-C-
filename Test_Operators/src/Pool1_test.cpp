...
void compareFile_pool1() {
    std::string file1 = "C:/Users/7501/Downloads/projects/Projects_MCW/data/output/pool1_output_1d.txt";
    std::string file2 = "C:/Users/7501/Downloads/projects/Projects_MCW/data/references/layer_pool1.txt";
    std::string output = "C:/Users/7501/Downloads/projects/Projects_MCW/report/Pool1_inference.txt";
